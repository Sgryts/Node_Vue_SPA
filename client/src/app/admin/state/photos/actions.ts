...
export const uploadRequest = createAction('[ADMIN PHOTO] Upload Request', props<{ params: IPhotoUpload }>());
...
export const updatePhoto = createAction('[ADMIN PHOTO] Update Photo', props<{ params: Partial<IPhoto> }>());
